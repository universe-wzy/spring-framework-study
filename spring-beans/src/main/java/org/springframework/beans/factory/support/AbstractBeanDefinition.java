...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	// 用来表示bean实例化，需要依赖另一个bean先实例化。对应depend-on
	@Nullable
	...
	// 是否以一种宽松的模式解析构造函数，默认true，如果设置为false，那么如下情况抛出异常
	// interface ITest()
	...
	// 是否是用户定义的，而不是程序本身定义的，创建AOP时为true
	...
	protected void prepareMethodOverride(MethodOverride mo) throws BeanDefinitionValidationException {
		...
		if (count == 0) {
			...
			// 这一步牛逼了，可能会有重载方法，count就会大于1，如果没有重载方法，这里优先搞定，节省开销
